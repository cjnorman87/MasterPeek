...
open class SwiftyCamViewController: UIViewController {
    ...
    fileprivate func videoInputPresetFromVideoQuality(quality: VideoQuality) -> String {
        switch quality {
        case .high: return AVCaptureSessionPresetHigh.rawValue
        case .medium: return AVCaptureSessionPresetMedium.rawValue
        case .low: return AVCaptureSessionPresetLow.rawValue
        ...
        case .resolution3840x2160:
            if #available(iOS 9.0, *) {
                ...
                return AVCaptureSessionPresetHigh.rawValue
            }
        }
    }
    
    /// Get Devices
    fileprivate class func deviceWithMediaType(_ mediaType: String, preferringPosition position: AVCaptureDevice.PositionAVCaptureDevice.Position) -> AVCaptureDevice? {
...
extension SwiftyCamViewController {
    ...
    @objc fileprivate func zoomGesture(pinch: UIPinchGestureRecognizer) {
        ...
        do {
            let capDevice = AVCaptureDevice.DiscoverySession
